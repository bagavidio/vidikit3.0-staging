...
import { ChartIncreaseIcon, FavouriteIcon, Notification01Icon } from "@hugeicons/core-free-icons";
      ...
      <div className="mx-auto max-w-4xl space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              { title: "Followers",  value: "48.2K", delta: "+12%",  icon: <HugeiconsIcon icon={FavouriteIcon} className="size-4 text-yellow-50" /> },
